...
__Warning: This package is being overhauled and it is not functional at this stage__
...
- one table per folder. It will be called "rbackupr_project_ProjectName", where "ProjectName" is the name of the project, typically set with `rb_set_project()`.
